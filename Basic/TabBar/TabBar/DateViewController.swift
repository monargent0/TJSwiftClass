...
class DateViewController: UIViewController { // multitasking (2가지 일 할거니까 CPU2개 사용) - CPU 1 : 현재시간 / CPU 2 : datePicker 선택시간
    ...
    let timeSelector : Selector = #selector(DateViewController.updateTime) // ObjectC // updateTime은 내가 만들 func
